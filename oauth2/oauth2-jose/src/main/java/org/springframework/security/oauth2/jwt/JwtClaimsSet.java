...
public final class JwtClaimsSet implements JwtClaimAccessor {
	...
	public static final class Builder {
		...
		public JwtClaimsSet build() {
			...
			convertAsURL(JwtClaimNames.ISS);
			return new JwtClaimsSet(this.claims);
		}

		private void convertAsURL(String claim) {
			...
			if (value != null) {
				...
				Assert.isTrue(convertedValue != null,
						() -> "Unable to convert claim '" + claim + "' of type '" + value.getClass() + "' to URL.");
				this.claims.put(claim, convertedValue);
			}
		}
